...
const fs = require('fs');
// const { Keypair } = require("@_koi/web3.js");
...
class Twitter extends Adapter {
  ...
  getSubmissionCID = async round => {
    if (this.proofs) {
      ...
      if (data && data.length === 0) {
        ...
        // const wallet = fs.readFileSync('/Users/markxie/Library/Application Support/KOII-Desktop-Node/namespace/qdmark_stakingWallet.json', "utf-8");
        // const userStaking = Keypair.fromSecretKey(
  ...
  parseItem = async item => {
    ...
    try {
      ...
      const sentiment = sentiment.analyze(tweet_text);
